<%-- 
    Document   : tipoCuenta
    Created on : 23/07/2015, 01:51:13 PM
    Author     : LUNA
--%>
...
<script src="js/catalogos/tipoCuenta.js" type="text/javascript"></script>

<div class="panel panel-default panelPantalla">
    <div class="panel-heading">
        <div class="row">
        <h2 class="tituloPantalla"> TIPO DE CUENTAS</h2>
        </div>
    </div>
            ...
            <div class="col-md-12">
                <div class="table-responsive">
                    <div class="container">
                        ...
                        <table id="tblTipoCuenta" class="display table-bordered table-hover" >
                            <thead>

<%-- 
    ...
    Document   : causaDevolucion
    Created on : 23/07/2015, 05:02:55 PM
    Author     : LUNA
    empresa    : SOMA
--%>
...
<script src="js/catalogos/causaDevolucion.js" type="text/javascript"></script>

<div class="panel panel-default panelPantalla">
    <div class="panel-heading">
        <div class="row">
            <h2 class="tituloPantalla"> CAUSAS DE DEVOLUCIÓN </h2>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="table-responsive">
                    <div class="container">
                        <table id="tblCausaDev" class="display table-bordered table-hover" >
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Clave</th>
